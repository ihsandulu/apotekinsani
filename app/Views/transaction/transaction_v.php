...
<div class='row'>
    <div class='col-7'>
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6"><a href="<?= base_url(); ?>" class=" btn btn-warning btn-xs fa fa-home"></a>
            ...
            <div class="card-body row">
                ...
                <div class="col-12 row">
                    ...
                    <form class="form col-12 ">
                        ...
                        <input onchange="listnota(-1)" type="date" id="from" name="from" class=" w-date" value="<?= $from; ?>" style="width: 50px;font-size: 10px;">&nbsp;
                        <label for="to">Ke:</label>&nbsp;
                        <input onchange="listnota(-1)" type="date" id="to" name="to" class=" w-date" value="<?= $to; ?>" style="width: 50px;font-size: 10px;">&nbsp;&nbsp;
                                ...
                                <div class="form-inline">
                                    ...
                                    <script>
                                        function changeQty(delta) {
                                            const input = document.getElementById("qtyproduct");
                                            let current = parseInt(input.value) || 0;
                                            let newVal = current + delta;

                                            // Cegah nilai kurang dari 1
                ...
                <script>
                    ...
                    function plistproduct(type, product_name) {
                        ...
                        // alert(positionm_id);
                        if (positionm_id == null) {
                            positionm_id = <?= $default; ?>;
                        }
