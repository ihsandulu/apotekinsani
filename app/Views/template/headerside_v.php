<div class="left-sidebar" style="overflow:scroll;">
        <!-- Sidebar navigation-->
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> 
                    <a class="  " href="<?= base_url("transactionp"); ?>" aria-expanded="false"><i class="fa fa-cart-arrow-down"></i><span class="hide-menu">Penjualan</span></a>
                </li>
                <?php }?>
