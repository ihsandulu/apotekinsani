...
class transactionnon_m extends core_m
{
    public function data()
    {
        ...
        if ($this->request->getPost("delete") == "OK") {  
            ...
            ->getNumRows();
            if($cek>0){
                $data["message"] = "Masih terdapat data detail transaction!";
            } else{            
                $this->db
                ->table("transaction")
        ...
        if ($this->request->getPost("create") == "OK") {
            ...
            if(isset($_POST["transaction_no"])&&$_POST["transaction_no"]!=""){
                $input["transaction_no"] = $_POST["transaction_no"];
            }else{
                $input["transaction_no"] = "PUN".date("YmdHis").session()->get("store_id");
            }
